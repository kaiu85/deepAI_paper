...
fig_propagated.savefig('fig_propagated.pdf')
...
fig_sampled.subplots_adjust(left=0.1, bottom=0.1, right=0.95, top=0.95,
                    wspace=0.3, hspace=0.3)
fig_sampled.savefig('fig_sampled.pdf')
...
def inner_fn_sample_actions_given(oat_given, stm1, otm1, ohtm1, oatm1):
    ...
    # inputs oa
    #
    # As we know that the processes are continous, we use the previous 
    # estimates for the other channels (otm1, ohtm1, oatm1) 
    # to initialize the sampling
    #
    # c.f. https://arxiv.org/abs/1401.4082, Appendix F.
    ((st, ot, oht, oat), _) = theano.scan(fn=inner_fn_condition, 
                                           outputs_info=[stm1, otm1, ohtm1, oatm1],#[st0_condition, ot0_condition, oht0_condition, oat0_condition],
...
((states_sampled_ag, observations_sampled_ag, rewards_sampled_ag, actions_observations_sampled_ag), _) =\
                     ...
                     outputs_info=[st0_init, ot0_init, oht0_init, oat0_init],
...
fig_constrained.subplots_adjust(left=0.1, bottom=0.1, right=0.95, top=0.95,
                    wspace=0.3, hspace=0.3)
fig_constrained.savefig('fig_constrained.pdf')
