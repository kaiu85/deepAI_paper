...
for i in range(len(filenames)):
	...
	n_iterations_ag = 10 # How many iterations of MCMC to perform for 
	...
	# Load learned Agent
	load_model(params, sigmas, filenames[i])
	...
	plt.subplot(2,3,1+i)
	if i == 0:
		plt.title('230 Iterations\n$o_a(t)$ propagated')
	if i == 1:
		plt.title('250 Iterations\n$o_a(t)$ propagated')
	if i == 2:
		plt.title('270 Iterations\n$o_a(t)$ propagated')
	for j in range(10):
